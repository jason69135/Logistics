...
<body>
	...
	享受一站式服务,请先<a href="RegisterAction.action">注册</a>
	...
	<form action="TrackGoodsAction.action" method="POST">
		货物追踪
		请输入运单号<input type="text" name="order.number">
		<input type="button" value="查询">
	</form>
	<form action="#" method="POST">
		网点查询
		请输入所在城市<input type="text" name="site.city">
		<input type="button" value="查询">
	</form>
	<form action="#" method="POST">
		货物追踪
		发货城市<input type="text" name="srcCity">
		收货城市<input type="text" name="tarCity">
		<input type="button" value="查询">
	</form>
</body>
</html>
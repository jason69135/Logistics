		...
		<TR>
			<TD width="100%">
				...
				<legend>添加分站点</legend>
					  ...
					  <tr>
					    <td nowrap align="right" width="13%">分站点名称：<br /></td>
					    <td width="41%"><input name="text" class="text" style="width:100px" type="text" size="40" /></td>
					    <td align="right" width="19%"><br /></td>
					    
					    </tr>
					  <tr>
					    <td nowrap align="right">站点地址：<br /></td>
					    <td><input name="" id="" class="text" style="width:154px" /></td>
					    <td align="right"><br /></td>
					    
					  </tr>
					   <tr>
					    <td nowrap align="right">所属总站点：<br /></td>
              ...
              <tr>
                ...
                <table width="621" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03" height="230">
					<tr>
                    <td height="20" colspan="14" align="center" class="tablestyle_title"><br /></td>
                    </tr>
                  <tr>
				    
                    <th  align="center" bgcolor="#EEEEEE">所属总站点</th>
                    <th  align="center" bgcolor="#EEEEEE">站点名</th>
                    <th  align="center" bgcolor="#EEEEEE">站点地址</th>
                    <th  align="center" bgcolor="#EEEEEE">管理员</th>

			...
			<table id="mainpage" width="100%" border="0" cellspacing="0"
				...
				<tr>
					<td>
									...
									<table width="95%" border="0" align="center" cellpadding="0"
										...
										<tr>
											<td height="40" class="font42">
												<div id="main_list">
													<table width="621" border="0" cellpadding="4"
						...
						<%
							List<Subsite> list = (List) session.getAttribute("subsitelist");
							for (int i = 0; i < list.size(); i++) {
								...
								out.println("</td>");
							    out.println("<td bgcolor='#FFFFFF'>");
								out.println(list.get(i).getSitename());
								out.println("</td>");
								out.println("<td bgcolor='#FFFFFF'>");  
								out.println(list.get(i).getSiteid());
								out.println("</td>");
								out.println("<td bgcolor='#FFFFFF'><a href='DeleteSubsiteAction.action'>删除</a>");
								session.setAttribute("subsiteid",list.get(i).getId());
								out.println("</tr>");
							}
						%>
													</table>
